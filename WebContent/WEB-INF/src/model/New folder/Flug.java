...
public class Flug implements Serializable {
    ...
    public Flug(int _flugid, String _flugnr, double std_sitzpreis, Flughafen _abflugsort, Flughafen _ankunftsort,
    ...
    public void setFlugnr(String _flugnr) { 
    	this.flugnr = _flugnr; 
    	}

    public ArrayList<Sitzplatz> getSitzplatz() {
    	return sitzplatz; 
    	}
    
    public void setSitzplatz(ArrayList<Sitzplatz> _sitzplatz) { 
    	this.sitzplatz = _sitzplatz; 
    	}

    public Flughafen getAbflugsort() { 
    	return abflugsort; 
    	}
    
    public void setAbflugsort(Flughafen _abflugsort) { 
    	this.abflugsort = _abflugsort; 
    	}

    public Flughafen getAnkunftsort() { 
    	return ankunftsort; 
    	}
    public void setAnkunftsort(Flughafen _ankunftsort) { 
    	this.ankunftsort = _ankunftsort; 
    	}

    public Date getAbflugsdatum() { 
    	return abflugsdatum; 
    	}
    
    public void setAbflugsdatum(Date _abflugsdatum) { 
    	this.abflugsdatum = _abflugsdatum; 
    	}
    ...
    public void setAnkunftsdatum(Date _ankunftsdatum) { 
    	this.ankunftsdatum = _ankunftsdatum; 
    	}

    public int getSitzplatzIndex(Sitzplatz _sitzplatz) { 
    	return (_sitzplatz.getSpalte()-1)*N_Sitzspalte + _sitzplatz.getZeile()-1; 
    	}
